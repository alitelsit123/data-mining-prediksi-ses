        ...
        <div class="col-md-6">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Edit Data Periode</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?= base_url('periode/update/' . $periode['id_periode']) ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" name="tahun" value="<?= $periode['tahun']; ?>" placeholder="Masukkan Tahun" value="<?= old('tahun'); ?>">
